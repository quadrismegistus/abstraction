...
from .config import PATH_CORPORA, PATH_DATA, PATH_STASH
...
__all__ = [
    # config
    "PATH_CORPORA", "PATH_DATA", "PATH_STASH",
    # corpus
    "load_corpus", "Corpus", "pmap", "pmap_iter",
    # tokenize
    "tokenize", "tokenize_agnostic", "get_stopwords",
    # norms
    "get_orignorms", "get_vecnorms", "get_allnorms",
    "get_origfields", "get_allfields",
    "get_origcontrasts", "get_allcontrasts",
    ...
    "gen_vecnorms",
    # counting
    "count_absconc", "count_absconc_psg", "count_absconc_corpus",
    # scoring
    "score_psg", "score_freqs", "score_words", "get_all_passages",
    "gen_bookpassages", "score_corpus_freqs", "score_all_corpora",
    # analysis
    "load_scores", "load_all_scored", "adjust_scores",
    "fit_arc", "fit_arc_corpus", "fit_arc_all_corpora",
    "fit_arc_by_genre", "fit_arc_all_by_genre", "harmonize_genre", "summarize_arc",
