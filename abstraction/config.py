...
PATH_NORMS_ES = os.path.join(FIELD_DIR, "data.wordnorms_orig.es.csv")
PATH_VECNORMS_ES = os.path.join(FIELD_DIR, "data.wordnorms_vec.es.pkl.gz")
PATH_ALLNORMS_ES = os.path.join(FIELD_DIR, "data.allnorms.es.pkl.gz")
PATH_MODELS_ES = os.path.join(PATH_DATA, "models_es")
ES_SOURCE_DIR = os.path.join(SOURCE_DIR, "es_norms")
PATH_ESPAL = os.path.join(ES_SOURCE_DIR, "EsPal.xlsx")
PATH_GUASCH = os.path.join(ES_SOURCE_DIR, "Guasch2015.xlsx")
